...
def same_floor_nav(goal_x, goal_y, goal_theta):
	global curr_floor, curr_x, curr_y
	outside_door_coord = {0: [2, -4.8, 1.57], 3: [3.5, -0.56, 1.57]}
	...
	inside_area = {0:[[-14.3, 7.1, -1.5, 6.9]], 3: [[-18, 4.3, -17.2, -5.5]]}
	outside_area = {0:[[-14.3, 7.1, -12.5, -5.3]], 3: [[-0.9, 4.7, -0.9, 2.2]]}
